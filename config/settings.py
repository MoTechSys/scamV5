...
ALLOWED_HOSTS = _allowed_hosts + ['8000-igjss473qvs9x7elvjck0-abca87f7.sg1.manus.computer', '.sg1.manus.computer', '.manus.computer', 'testserver']
...
LOGGING = {
    ...
    'handlers': {
        ...
        'ai_file': {
            'level': 'INFO',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': LOGS_DIR / 'ai_features.log',
            'maxBytes': 10 * 1024 * 1024,  # 10 MB
            'backupCount': 5,
            'formatter': 'detailed',
            'encoding': 'utf-8',
...
if not DEBUG:
    ...
    # HSTS Settings (uncomment for HTTPS)
