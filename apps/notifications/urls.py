...
urlpatterns = [
    ...
    path('admin/<int:pk>/edit/', views.AdminNotificationEditView.as_view(), name='admin_edit'),
    path('admin/<int:pk>/delete/', views.AdminNotificationDeleteView.as_view(), name='admin_delete'),
]
