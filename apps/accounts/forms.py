...
class AdminUserEditForm(forms.ModelForm):
    """
    نموذج تعديل المستخدم المحسّن للمدير الأعلى
    يتيح التحكم الكامل في جميع خصائص المستخدم
    """
    ...
    class Meta:
        ...
        fields = ['academic_id', 'id_card_number', 'full_name', 'email', 
                  'role', 'major', 'level', 'account_status', 'is_active', 
                  'phone_number']
        widgets = {
            'academic_id': forms.TextInput(attrs={'class': 'form-control'}),
            'id_card_number': forms.TextInput(attrs={'class': 'form-control'}),
...
class RoleForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # إذا كان تعديل، لا يمكن تغيير الكود
